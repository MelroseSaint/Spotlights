...
export const getTrendingPosts = defineQuery({
  args: {
    limit: v.optional(v.number()),
  },
...
// Like a post
export const likePost = defineMutation({
  args: {
    userId: v.id("users"),
    postId: v.id("posts"),
  },
...
// Unlike a post
export const unlikePost = defineMutation({
  args: {
    userId: v.id("users"),
    postId: v.id("posts"),
  },
...
export const hasLikedPost = defineQuery({
  args: {
    userId: v.id("users"),
    postId: v.id("posts"),
  },
...
export const getComments = defineQuery({
  args: {
    postId: v.id("posts"),
    limit: v.optional(v.number()),
  },
...
export const sharePost = defineMutation({
  args: {
    postId: v.id("posts"),
  },
